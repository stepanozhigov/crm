    ...
    <div class="row-cont">
        <article id="post-1732" class="post-1732 page type-page status-publish hentry">
            ...
            <header class="row-cont__hello">
                <h2 class="row-cont__hello-header">{{ __('Консультация (Мужчина)') }}</h2>
            </header>
...
<section id="row__consult">
    <div class="row-cont">
        <x-LK.consult-block :pageSettings="$pageSettings" gender="men"/>
        ...
        <div class="list20190906 list20190906_single">
            <div class="list20190906_box">
                @foreach($pageSettings['commentsMan'] as $commentsMan)
                <div class="list20190906_item">
                    <p><strong>{{ $commentsMan['name'] }}</strong></p>
                    {!! $commentsMan['text'] !!}
